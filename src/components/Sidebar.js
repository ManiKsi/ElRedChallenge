  ...
  return (
    <div className=' bg-white rounded-md w-52 pb-5 flex-shrink-0 px-4'>
      ...
      <div className=' text-gray1 text-xs font-medium   flex flex-col'>
        <div className=' flex items-center pl-3 py-4 hover:bg-pink rounded-md cursor-pointer my-1 '>
          <div className='w-10'>
            <DashboardIcon
              fill='#BABABA'
        ...
        <div className=' flex items-center pl-3 py-4 bg-pink rounded-md cursor-pointer my-1'>
          <div className=' w-10'>
